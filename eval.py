...
class Evaluater(object):
    def __init__(self, args):
        ...
        self.train_loader, self.val_loader, self.test_loader, self.nclass, self.data_stats = make_data_loader(args, **kwargs)
...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='construction',
                        choices=['pascal', 'coco', 'cityscapes', 'construction'],
